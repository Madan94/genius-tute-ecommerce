...
import LanguageDropdown from "./GenderDropdown";
...
const ShopWithSidebar = () => {
  ...
  return (
    <>
      ...
      /> */}
      <section className="overflow-hidden relative pb-20 pt-5 lg:pt-20 xl:pt-50 bg-[#f3f4f6]">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2.5">
                    <button
                      ...
                      } flex items-center justify-center w-10.5 h-9 rounded-[5px] border ease-out duration-200 hover:bg-orange hover:border-orange hover:text-white`}
                    >
                      <svg
                        className="fill-current"
                        width="18"
                ...
                <div className="bg-white shadow-1 rounded-md p-2">
                  <ul className="flex items-center">
                    ...
                    <li>
                      <a
                        href="#"
                        className="flex py-1.5 px-3.5 duration-200 rounded-[3px] bg-orange text-white hover:text-white hover:bg-orange"
                      >
                        1
                      </a>
                    </li>
                    ...
                    <li>
                      <a
                        href="#"
                        className="flex py-1.5 px-3.5 duration-200 rounded-[3px] hover:text-white hover:bg-orange"
                      >
                        2
                      </a>
                    </li>
                    ...
                    <li>
                      <button
                        ...
                        aria-label="button for pagination left"
                        type="button"
                        className="flex items-center justify-center w-8 h-9 ease-out duration-200 rounded-[3px] hover:text-white hover:bg-orange disabled:text-gray-4"
                      >
                        <svg
                          className="fill-current"
                          width="18"
